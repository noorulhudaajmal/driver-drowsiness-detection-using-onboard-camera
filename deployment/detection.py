...
# import tflite.interpreter as tlfite
...
yawning = YawningModel("models/yawning_model.tflite")
eyes = BlinkingModel("models/blinking_model.tflite")
...
while success:
    ...
    if isinstance(s, np.ndarray):
        ...
        blinks.append(eyes.predict(l_eye))
        blinks.append(eyes.predict(r_eye))
        yawns.append(yawning.predict(mouth))
